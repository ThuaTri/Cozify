...
CREATE TABLE [order] (
    ...
    status NVARCHAR(50) NOT NULL, -- Pending, Packaging, Delivering, Delivered, Cancelled
    payment_method NVARCHAR(50) NOT NULL, -- Only COD for now
...
INSERT INTO [order] ([user_id], order_time, status, payment_method, [address], phone_number, total, note)
VALUES
    -- Pending
    (1, '2022-01-05 12:00:00', 'Pending', 'COD', '1234 Street, City, State', '1234567890', 99.99, 'Please deliver before 6 PM'),
    (2, '2022-01-07 13:00:00', 'Pending', 'COD', '1234 Lane, City, State', '2345678901', 89.99, 'Leave at the front door'),

    -- Packaging
    (1, '2022-01-10 14:00:00', 'Packaging', 'COD', '1234 Road, City, State', '3456789012', 79.99, null),
    (2, '2022-01-12 15:00:00', 'Packaging', 'COD', '1234 Blvd, City, State', '4567890123', 69.99, null),

    -- Delivering
    (1, '2022-01-15 16:00:00', 'Delivering', 'COD', '1234 Ave, City, State', '5678901234', 59.99, 'Call upon arrival'),
    (2, '2022-01-17 17:00:00', 'Delivering', 'COD', '1234 St, City, State', '6789012345', 49.99, 'No need to ring the bell'),

    -- Delivered
    (1, '2022-01-20 18:00:00', 'Delivered', 'COD', '1234 Ln, City, State', '7890123456', 39.99, NULL),
    (2, '2022-01-22 19:00:00', 'Delivered', 'COD', '1234 Rd, City, State', '8901234567', 29.99, NULL),

    -- Cancelled
    (1, '2022-01-25 20:00:00', 'Cancelled', 'COD', '1234 Blvd, City, State', '9012345678', 19.99, NULL),
    (2, '2022-01-27 21:00:00', 'Cancelled', 'COD', '1234 Ave, City, State', '0123456789', 9.99, NULL);
